            ...
            <div className="mt-5 w-[75%] space-y-8 max-md:w-full">
                <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
                    <div className="mb-4 flex items-center">
                        <button onClick={(() => window.location.href = '/gluecrypt/account')} className="flex items-center gap-2 text-sm font-medium text-gray-500 transition-colors hover:text-[#36382e]"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m15 18-6-6 6-6" /></svg>
                            Wróć
                        </button>
                    </div>
                    <div className={'flex flex-col items-center'}>
                        ...
                        <div className={'mt-5 flex w-full justify-center gap-3'}>
                            <div className={'flex w-full max-w-[50%] flex-col gap-2'}>
                                ...
                                <textarea disabled className={'h-12 w-full rounded-lg border border-gray-200 bg-gray-50 p-3 text-sm text-gray-700'}>
                                    fghfg
                                </textarea>
                            </div>
                            <div className={'flex w-full max-w-[50%] flex-col gap-2'}>
